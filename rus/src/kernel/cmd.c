...
void cmd_uname(void) {
    printf("XC-OS v0.3 i386 (XCFS v2) | {FG(0,200,255)}Right Alt{FG(255,255,255)} - RU/EN layout\n");
}
...
void cmd_help(void) {
    printf("{FG(0,200,255)}[Tip] Press {FG(255,255,0)}Right Alt{FG(0,200,255)} to toggle RU/EN keyboard layout{FG(255,255,255)}\n\n");
