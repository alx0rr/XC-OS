...
static const int MY_BOLD_PERCENT = 5;
...
static void init_font_metrics() {
    ...
    int extra_h = (MY_FONT_W * MY_BOLD_PERCENT + 50) / 100;
    int extra_v = (MY_FONT_H * MY_BOLD_PERCENT + 50) / 100;
    ...
    )
{
    init_font_metrics();
    int extra_h = (MY_FONT_W * MY_BOLD_PERCENT + 50) / 100;
    int extra_v = (h * MY_BOLD_PERCENT + 50) / 100;
