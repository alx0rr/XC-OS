...
void help() {
    ...
    printf("\n");
    printf("{FG(0,255,255)}=== Network Commands ===\n");
    printf("  {FG(255,255,0)}netinit{FG(255,255,255)}   - Initialize network card\n");
    printf("  {FG(255,255,0)}ifconfig{FG(255,255,255)}  - Show/set IP configuration\n");
    printf("  {FG(255,255,0)}ping{FG(255,255,255)} <ip> - Send ICMP ping\n");
    printf("  {FG(255,255,0)}netstat{FG(255,255,255)}   - Network statistics\n");
    printf("  {FG(255,255,0)}arp{FG(255,255,255)}       - Show ARP cache\n");
    printf("  {FG(255,255,0)}route{FG(255,255,255)}     - Show routing table\n");
    printf("  {FG(255,255,0)}lspci{FG(255,255,255)}     - List PCI devices\n");
    printf("  {FG(255,255,0)}nettest{FG(255,255,255)}   - Test network connectivity\n");
    printf("\n");
